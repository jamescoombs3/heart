...
# Output data
## gap_data-v6-calib.csv - uses primary schools' FSM as a reference. 
...
## school-to-idaci.csv - uses Income Deprivation Affecting Children Index (IDACI) as a reference. 
